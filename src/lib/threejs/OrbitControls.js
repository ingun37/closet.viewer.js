...
THREE.OrbitControls = function ( object, domElement ) {
	...
	// The four arrow keys
	this.keys = { LEFT: 37, UP: 38, RIGHT: 39, BOTTOM: 40, NUM0: 96 , NUM1: 97, NUM2: 98, NUM3: 99, NUM4: 100, NUM5:101, NUM6: 102, NUM7: 103, NUM8: 104, NUM9: 105};
	...
	function onMouseDown( event ) {
		...
		} else if (event.button === THREE.MOUSE.LEFT && event.altKey === false) {
		...
		} else if (event.button === THREE.MOUSE.MIDDLE || (event.button === THREE.MOUSE.LEFT && event.altKey === true)) {
